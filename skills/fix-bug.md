# Fix Mobile Bug Guide

This guide provides a structured approach to debugging and fixing bugs in React Native/TypeScript mobile applications.
...
- [ ] Metro bundler console for errors/warnings
- [ ] Flipper Network tab for failed API requests
- [ ] React DevTools (in React Native Debugger) for component state
- [ ] Redux DevTools for state changes
- [ ] TypeScript errors in IDE/terminal
- [ ] Check if issue reproduces on both iOS and Android
...
```typescript
// ❌ NativeWind class not working
<View className="bg-primary"> // Custom color not defined
...
// ❌ Class name typo
<View className="flex-col items-centres"> // 'centres' is wrong
...
<View className={cn("base-styles", conditional && "override-styles")}>
```
...
# - Layout: View component hierarchy
# - Databases: View AsyncStorage/MMKV
```
...
```bash
# iOS Debugging (Xcode)
# - View crash logs: xcrun simctl spawn booted log stream
# - Instruments for performance profiling

# Android Debugging (Android Studio)
# - Logcat: adb logcat -s ReactNative:V
...
- [Component Patterns](../guides/component-patterns.md) - React Native component best practices
- [Data Fetching](../guides/data-fetching.md) - HTTP service patterns
- [Common Patterns](../guides/common-patterns.md) - Redux and form patterns
- [TypeScript Standards](../guides/typescript-standards.md) - Type safety guidelines
- [Mobile Testing](../guides/mobile-testing.md) - Debugging and testing guide
