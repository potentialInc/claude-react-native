...
TypeScript best practices for type safety and maintainability in React Native applications.
...
// TextInput change (onChangeText is simpler)
const handleChangeText = (text: string) => {
  setValue(text);
};

// TextInput change event (if you need the event)
...
const handlePress = (e: GestureResponderEvent) => {
  // Access e.nativeEvent for touch coordinates
};
